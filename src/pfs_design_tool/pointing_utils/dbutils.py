...
def generate_targets_from_gaiadb(
    ...
    """
        ...
        # psycopg2 cursor used as context manager: cur.close() is called automatically on exit
        ...
        # conn.close() releases the TCP connection back to the server; called even on exception
        conn.close()
